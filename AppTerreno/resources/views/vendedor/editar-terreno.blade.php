...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
    ...
    <div class="lg:col-span-4">
        <h2 class="text-3xl font-black text-green-700 mb-4">Editar Terreno</h2>
        ...
        <!-- Showcase Image -->
        <div class="h-96 bg-gray-200 rounded-xl flex items-end p-6 relative overflow-hidden">
            ...
            @else
                <div class="absolute inset-0 flex flex-col items-center justify-center text-gray-400 bg-slate-100">
    ...
    <div class="lg:col-span-8 flex flex-col gap-6">
        ...
        <section class="bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre', $terreno->nombre) }}" placeholder="Ej: Terreno Sustentable en Valle Verde" class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" required>
                    @error('nombre')
                ...
                <div>
                    ...
                    <textarea name="descripcion" rows="4" placeholder="Describa el potencial..." class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" required>{{ old('descripcion', $terreno->descripcion) }}</textarea>
                    @error('descripcion')
                        <p class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="precio" value="{{ old('precio', $terreno->precio) }}" placeholder="0.00" class="w-full pl-8 pr-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" required>
                        </div>
                        @error('precio')
                            <p class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="ubicacion" value="{{ old('ubicacion', $terreno->ubicacion) }}" placeholder="Colonia, Calle, Ciudad" class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" required>
                        </div>
                        @error('ubicacion')
                            <p class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</p>
                        @enderror
        ...
        <section class="bg-white rounded-2xl p-8 shadow-sm border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" step="0.01" name="largo" value="{{ old('largo', $terreno->largo) }}" placeholder="Largo en metros" class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" required>
                    @error('largo')
                        <p class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" step="0.01" name="ancho" value="{{ old('ancho', $terreno->ancho) }}" placeholder="Ancho en metros" class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors" required>
                    @error('ancho')
                        <p class="text-red-500 text-xs mt-1 font-semibold">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 mt-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <a href="{{ route('vendedor.terrenos.index') }}" class="py-3 px-6 border border-gray-300 text-gray-700 text-center font-bold rounded-lg hover:bg-gray-50 transition-colors text-sm">
                    Cancelar
                </a>
