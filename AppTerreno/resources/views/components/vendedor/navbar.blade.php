    ...
    <div class="flex items-center gap-6">
        ...
        <div class="flex items-center gap-3 pl-6 border-l border-gray-200">
            ...
            <div class="text-right">
                <p class="text-sm font-bold text-gray-900">{{ $nombreCorto }}</p>
            ...
            @else
            <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-bold uppercase border border-gray-300">
                {{ $iniciales }}
            </div>
            @endif
