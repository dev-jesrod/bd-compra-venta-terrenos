...
@if($verificado)
    <span class="inline-flex items-center gap-1 bg-green-50 border border-green-200 {{ $tamano === 'sm' ? 'text-[9px] px-2 py-0.5' : 'text-[10px] px-2.5 py-1' }} rounded-full font-bold uppercase tracking-wider">
