...
<main class="flex-1 flex bg-white min-h-[calc(100vh-80px)]">
    ...
    <div class="hidden lg:block lg:w-1/2 relative">
        <img src="{{ asset('storage/registro-vendedor-bg.jpg') }}" class="absolute inset-0 w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/20 flex items-center justify-center">
            <span class="text-white font-black text-3xl uppercase tracking-widest text-center px-10">Paisaje de Mazatlán</span>
        </div>
    </div>
