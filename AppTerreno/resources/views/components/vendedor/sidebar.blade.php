<aside class="fixed left-0 top-0 h-full flex flex-col bg-slate-50 dark:bg-slate-950 border-r border-gray-200 dark:border-gray-800 w-64 z-50">
    ...
    <nav class="flex-1 px-4 mt-4 space-y-1">
        <a class="flex items-center gap-3 px-4 py-3 {{ request()->is('dashboard') ? 'text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-900/20 border-r-4 border-green-700 dark:border-green-400' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800' }} transition-colors font-medium text-sm rounded-lg" href="{{ url('/dashboard') }}">
