...
<main class="flex-1 bg-white">
    ...
    <div class="flex flex-col lg:flex-row min-h-[600px]">
        ...
        <div class="lg:w-1/2 relative bg-gray-300 min-h-[400px] lg:min-h-full flex items-center justify-center">
            ...
            <div class="absolute inset-0 bg-black/30 flex flex-col justify-end p-10 lg:p-16">
                <h1 class="text-white text-5xl lg:text-5xl font-black leading-tight mb-4">Encuentra tu<br>lugar ideal en la<br>naturaleza</h1>
        ...
        <div class="lg:w-1/2 flex flex-col items-center justify-center p-10 lg:p-20 text-center">
            ...
            <h2 class="text-5xl lg:text-7xl font-black text-green-700 tracking-wider mb-6 leading-none">MAZ<br>TERRENOS</h2>
            <p class="text-gray-600 text-sm font-medium leading-relaxed max-w-sm mb-10">
                Bienvenido a <span class="font-bold">maz terrenos</span>. Descubre una forma consciente de habitar el mundo.
            </p>
            <button class="bg-green-700 hover:bg-green-800 text-white font-bold py-3 px-8 rounded-lg mb-10 flex items-center gap-2 transition-colors">
            ...
            <div class="w-full max-w-md flex items-center bg-gray-50 border border-gray-200 rounded-xl p-1 shadow-sm">
                ...
                <input type="text" placeholder="¿Qué tipo de terreno buscas?" class="flex-1 bg-transparent border-none focus:ring-0 text-sm px-4" />
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-20 py-20">
        <div class="flex justify-between items-end mb-10">
            <div>
                ...
                <p class="text-gray-500 font-medium text-sm">Las mejores oportunidades de inversión en entornos naturales.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
                <div class="relative bg-gray-300 aspect-[4/3] flex items-center justify-center">
                    ...
                    <span class="absolute top-4 right-4 bg-white text-green-700 text-[10px] font-black uppercase px-3 py-1 rounded-full z-20">Nuevo</span>
                </div>
                <div class="p-6 flex flex-col flex-1">
                    ...
                    <div class="flex gap-4 text-gray-400 text-xs font-semibold mb-6">
                        <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">square_foot</span> 5000 m2</span>
                        <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">eco</span> Sostenible</span>
                    </div>
                    <button class="w-full bg-gray-50 hover:bg-green-50 text-green-700 font-bold py-3 rounded-lg text-sm transition-colors border border-green-100">
                        Ver Detalles
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
                ...
                <div class="p-6 flex flex-col flex-1">
                    ...
                    <div class="flex gap-4 text-gray-400 text-xs font-semibold mb-6">
                        <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">square_foot</span> 2000 m2</span>
                        <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">visibility</span> Vista Panorámica</span>
                    </div>
                    <button class="w-full bg-gray-50 hover:bg-green-50 text-green-700 font-bold py-3 rounded-lg text-sm transition-colors border border-green-100">
                        Ver Detalles
                    </button>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
                ...
                <div class="p-6 flex flex-col flex-1">
                    ...
                    <div class="flex gap-4 text-gray-400 text-xs font-semibold mb-6">
                        <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">square_foot</span> 8000 m2</span>
                        <span class="flex items-center gap-1"><span class="material-symbols-outlined text-[16px]">water</span> Cerca del Río</span>
                    </div>
                    <button class="w-full bg-gray-50 hover:bg-green-50 text-green-700 font-bold py-3 rounded-lg text-sm transition-colors border border-green-100">
                        Ver Detalles
                    </button>
    ...
    <div class="bg-green-700 py-24 px-6 text-center">
        ...
        <button class="bg-[#1a1e26] hover:bg-black text-white font-bold py-4 px-8 rounded-xl transition-colors shadow-lg">
