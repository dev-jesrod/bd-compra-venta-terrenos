...
<body class="text-on-surface selection:bg-primary-fixed selection:text-on-primary-fixed">
        ...
        <div class="max-w-screen-2xl mx-auto flex flex-col items-center justify-center py-6 px-8 relative">
            ...
            <div class="absolute left-8 top-1/2 -translate-y-1/2">
                <div class="w-12 h-12 rounded-full overflow-hidden border border-outline-variant">
                    <img class="w-full h-full object-cover" data-alt="Minimalist 'casita' logo for Maz Terrenos"
                        src="https://lh3.googleusercontent.com/aida/ADBb0ug8LxtLBIopamEkJf3TU3pG7StjO5DRYDmKIyi9Y7Hpaji8sK_2npXw1FGQLyFIiEtpcbw1tiWGmUqd8bhPwXKNjCnvyBgF3bPFs0Pwysre-E2JBTu9wdWTXxl3MlVN5MdginwPwSrc3g3k-aW1fhWnXEZmYO0lBtjViHOkCZARBe8uZPybkX_BcuYoiQ3q7O3KleQijcPicVU9zxOsA7Q-25hb89HQfcY03htQTv5DKAUXPVm7TuVclJ9QVM9rAPfUZ0jnnV3Xvg" />
                </div>
            </div>
            <!-- Centered Identity -->
            <div class="text-center">
                ...
                <span
                    class="font-serif italic text-sm tracking-widest text-green-700 opacity-80 block mt-1 uppercase">INVERSIÓN
                    CONSCIENTE, LEGADO NATURAL</span>
            </div>
            <!-- Right Action -->
            <div class="absolute right-8 top-1/2 -translate-y-1/2 hidden md:flex items-center gap-6">
                <span
                    class="material-symbols-outlined text-slate-600 hover:text-green-700 cursor-pointer transition-colors">account_circle</span>
            </div>
        </div>
    </nav>
    <main class="pt-32 pb-24 max-w-6xl mx-auto px-6">
        ...
        <header class="text-center mb-12">
            <h1 class="text-5xl md:text-7xl mb-4 tracking-tight" style="color: #228B22;">Emerald Sanctuary in Valle
                Verde</h1>
        ...
        <section class="relative mb-20">
            <div class="w-full aspect-[21/9] rounded-xl overflow-hidden shadow-2xl relative">
                <img class="w-full h-full object-cover"
                    data-alt="sweeping aerial view of a dense emerald green forest canopy with mist rising between ancient pines in soft morning light"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDR0Ujk2TtrkgDya0jFylRuJjtr82xLL6HkczJ9iasR8NytjuFm6RD2kiRP7VLQep6gUuZGeydzsn6n2xiRydeYqwbqpXiIAteCa73WkWLumiEf8ljWxdNU6-SPi46yQAoC1FG5F7lG9k-wzuM-OvvyQoZVgEVB0l4wB6854ExRzplbGfRiSKlH1kTNYBke8pqxRyn5S6xnsUWiEoTM4dx2bwY0J19KyXlqEqAeWQ6N0Fy8pHqP9Ihya-qcspE3nyBecWDA1x3EjHst" />
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 px-4 -mt-12 relative z-10">
                <div
                    class="bg-white p-6 rounded-xl shadow-sm border border-green-200 flex flex-col items-center text-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
            ...
            <div class="lg:col-span-2 space-y-12">
                <div>
                    ...
                    <p class="text-on-surface-variant font-body leading-relaxed text-lg">
                        Un refugio terrenal diseñado para quienes buscan trascender. Ubicado en el corazón de Valle
                        Verde, este terreno ofrece una topografía equilibrada que permite construcciones orgánicas sin
                        alterar el flujo natural del ecosistema. Un santuario donde el legado y la inversión consciente
                        se encuentran.
                    </p>
                </div>
                <div class="bg-surface-container-low p-8 rounded-xl">
                    ...
                    <div class="grid grid-cols-2 gap-y-6">
                        <div>
                            <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">Superficie
                            </p>
                        ...
                        <div>
                            <p class="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-1">Zonificación
                            </p>
            ...
            <aside class="space-y-8 sticky top-36">
                <div class="bg-surface-container-highest p-8 rounded-xl">
                    <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 mb-6">DATOS DEL VENDEDOR
                    </p>
                    <div class="flex items-center gap-4 mb-6">
                        <img class="w-16 h-16 rounded-full object-cover grayscale hover:grayscale-0 transition-all duration-500 border-2 border-white"
                            data-alt="professional portrait of a middle-aged man with a warm smile, wearing a linen shirt, natural outdoor lighting background"
                            src="https://lh3.googleusercontent.com/aida-public/AB6AXuBrom6RbPrRQU9M9M1-qmp_EMppWrKEdskbhWRlVkTd5ODToEO5kb-s2ZKz-EZFTpU1NxwSpVqoJmbepcyEAOuEudFuwO3bp8pJAgY55FYhYia3lk6FktklwK8XjGL7Ak_flhHRQUm9gv8AQlPvephBC3Ut3jndRPpWybU_3tQme4-SLnN9MGaEhutSibaeSzYgXaWnU3FGmQtqQOKVNhrKZcI-XRxLf-Mfqo8SilCtSSO3nK1-lREz1TwChgshFw3Zl_-F8o-_GMbZ" />
                        <div>
                    ...
                    <button
                        class="w-full py-4 bg-on-surface text-white rounded-full font-body font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-primary transition-colors">
                ...
                <div class="p-8 border border-outline-variant/50 rounded-xl">
                    ...
                    <form class="space-y-4">
                        <input
                            class="w-full bg-transparent border-0 border-b border-outline-variant focus:ring-0 focus:border-primary text-sm font-body uppercase tracking-wider px-0 py-3 placeholder:text-slate-300"
                        ...
                        <button
                            class="w-full py-4 mt-4 bg-gradient-to-r from-primary to-primary-container text-white rounded-full font-body font-extrabold text-xs uppercase tracking-[0.15em] shadow-lg shadow-primary/20">
                            EXPRESS INTEREST
                        </button>
                    </form>
                </div>
    ...
    <footer class="fixed bottom-0 left-0 w-full z-[100] md:hidden">
        <div class="bg-on-surface text-white p-6 flex justify-between items-center">
            ...
            <button
                class="bg-primary px-8 py-3 rounded-full flex items-center gap-2 text-xs font-bold uppercase tracking-widest">
                COMPRAR AHORA
    ...
    <footer
        class="hidden md:flex w-full flex-col items-center justify-center space-y-8 border-t border-slate-100 bg-slate-50 py-16 mt-20">
        ...
        <p class="text-[10px] text-slate-400 uppercase tracking-[0.2em]">© 2024 Maz Terrenos. Inversión consciente,
            legado natural.</p>
        <div class="fixed bottom-10 right-10">
            <button
                class="bg-green-700 text-white pl-8 pr-4 py-4 rounded-full flex items-center gap-6 shadow-2xl group hover:bg-primary transition-all duration-300">
                <span class="text-xs font-bold uppercase tracking-[0.2em]">COMPRAR AHORA</span>
                <span
                    class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center group-hover:translate-x-1 transition-transform">
                    <span class="material-symbols-outlined text-sm">arrow_forward</span>
                </span>
            </button>
        </div>
