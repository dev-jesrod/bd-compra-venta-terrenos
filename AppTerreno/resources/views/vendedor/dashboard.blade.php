...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
        <div class="flex justify-between items-start mb-4">
            ...
            <span class="text-green-600 text-sm font-bold bg-green-50 dark:bg-green-900/30 px-2 py-1 rounded">+12%</span>
        </div>
        <p class="text-gray-500 text-sm font-medium">Total Vistas (Simulado)</p>
        <h3 class="text-3xl font-extrabold mt-1 text-gray-900 dark:text-white">{{ number_format($totalVistas) }}</h3>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
        <div class="flex justify-between items-start mb-4">
            ...
            <span class="text-green-600 text-sm font-bold bg-green-50 dark:bg-green-900/30 px-2 py-1 rounded">+5%</span>
        </div>
        <p class="text-gray-500 text-sm font-medium">Nuevos prospectos</p>
        <h3 class="text-3xl font-extrabold mt-1 text-gray-900 dark:text-white">{{ $totalProspectos }}</h3>
    </div>

    <!-- Stat 3: Apartados Activos -->
    <div class="bg-primary text-white p-6 rounded-xl border border-primary shadow-sm shadow-green-900/10">
        <div class="flex justify-between items-start mb-4">
...
<div class="bg-slate-900 text-white p-8 rounded-xl mb-12 flex flex-col md:flex-row gap-8 items-center border border-slate-800 shadow-xl">
...
<div class="mb-8">
    <div class="flex items-center justify-between mb-6">
        <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Estado de Documentación</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 flex items-center gap-4 shadow-sm">
            ...
            <div class="flex-grow">
                <h5 class="font-bold text-gray-900 dark:text-white text-sm">INE</h5>
        ...
        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 flex items-center gap-4 shadow-sm">
            ...
            <div class="flex-grow">
                <h5 class="font-bold text-gray-900 dark:text-white text-sm">RFC</h5>
        ...
        <div class="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-200 dark:border-gray-800 flex items-center gap-4 shadow-sm">
            ...
            <div class="flex-grow">
                <h5 class="font-bold text-gray-900 dark:text-white text-sm">Comprobante</h5>
