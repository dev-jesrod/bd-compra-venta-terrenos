        ...
        <div
            ...
            <div class="relative h-48">
                <img alt="Terreno Seco"
                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                    src="https://images.unsplash.com/photo-1595815771614-ade9d652a65d?w=800&h=600&fit=crop">
                <div
        ...
        <div
            ...
            <div class="relative h-48">
                <img alt="Macrolote Industrial"
                    class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                    src="https://images.unsplash.com/photo-1628075187659-e4d4b0394070?w=800&h=600&fit=crop">
                <div
